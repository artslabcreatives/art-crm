...
class Install extends Command
{
     ...
     * @var string
     */
    protected $signature = 'artcrm-crm:install';
    ...
    public function handle()
    {
        ...
        $this->warn('Step: Seeding basic data for Art CRM kickstart...');
        ...
        $this->info('The installation has been finished and you can now use Art CRM.');
    ...
    */
    ...
    {
        $dbName = $this->ask('What is the database name to be used by Art CRM ?');
